    ...
    public class ApplicationTextResolver
    {
        ...
        private ApplicationTextResolver()
        {
            _defaultTexts = new()
            {
                ...
                { ApplicationTexts.AvailableModules, "Available modules" },
                ...
                { ApplicationTexts.CannotDisplayHelpUnknownCommand, "Cannot display help for unknown command '{0}'" },
                { ApplicationTexts.CannotDisplayHelpUnknownModule, "Cannot display help for unknown module '{0}'" },
                ...
                { ApplicationTexts.InvalidNameNull, "The name cannot be null" },
                { ApplicationTexts.InvalidNameWithParameter, "The name '{0}' is invalid" },
